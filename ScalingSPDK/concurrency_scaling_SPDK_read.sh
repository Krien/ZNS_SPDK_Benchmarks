...
LD_LIBRARY_PATH="$LD_LIBRARY_PATH:$SPDK_DIR/build/lib" LD_PRELOAD="$SPDK_DIR/build/fio/spdk_nvme" fio "$jobname" --output="./out/concurrency_scaling_read_spdk_${job_cnt}.json" --output-format="json"
done
